...
export default function Account() {
  ...
  return (
    <section>
      <div className="mx-auto bg-blue-200 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow">
          <div className="p-6 sm:p-12">
            ...
            <button onClick={()=>router.push('/orders')} className="mt-5  inline-block bg-white text-blue-700 px-5 py-3 text-xs font-medium uppercase tracking-wide">
              View Your Orders
            </button>
            <div className="mt-6">
              <h1 className="font-bold text-lg text-white">Your Addresses :</h1>
              {pageLevelLoader ? (
                <PulseLoader
                  color={"#000000"}
                    ...
                    addresses.map((item) => (
                      <div className="border p-6" key={item._id}>
                        ...
                        <button
                          ...
                          className="mt-5 mr-5 inline-block bg-white text-blue-700 px-5 py-3 text-xs font-medium uppercase tracking-wide"
                        >
                          Update
                        </button>
                        <button
                          onClick={() => handleDelete(item._id)}
                          className="mt-5  inline-block bg-white text-blue-700 px-5 py-3 text-xs font-medium uppercase tracking-wide"
                        >
                          {componentLevelLoader &&
