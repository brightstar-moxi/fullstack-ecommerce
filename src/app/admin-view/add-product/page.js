...
import SelectComponents from "@/components/FormElement/SelectComponents";
...
async function helperForUPloadingImageToFirebase(file) {
  ...
  const storageReference = ref(storage, `cool/${getFileName}`);
                    ...
                    </div>
                    {
                        adminAddProductformControls.map(controlItem =>
                            controlItem.componentType === 'input' ? (
                                ...
                                controlItem.componentType === 'select' ? (<SelectComponents
                                    label={controlItem.label}
